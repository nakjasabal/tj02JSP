...
<body>
	...
	완전히 서로 다른 페이지를 의미한다. 따라서 page, request영역 모두
	공유되지 않는다.  -->
	...
	<!-- 포워드 된 페이지에서는 request영역이 공유된다. 주소표시줄
	에는 최초 요청한 페이지의 경로가 보여지지만, 사용자는 포워드
	된 페이지의 내용을 보게된다. 즉, 하나의 요청을 2개의 페이지가
	공유하는 개념이다.  -->
    ...
    <jsp:forward page="/07ActionTag/ForwardSub.jsp" />
   	...
   	<%
   	/* 액션태그를 사용하면 JSP코드보다 훨씬 더 간결하게 코드를 표현할 수
   	있다. */
